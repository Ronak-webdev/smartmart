...
export const categoriesData = [
  ...
  { slug: "dairy-eggs", name: "Dairy & Milk", image: dairy_eggs },
];
...
export const appPromoBannerData = {
  ...
  description:
    "Download the Smartmart app for exclusive deals, real-time tracking, and the freshest selection delivered right to your door.",
};

export const footerData = {
  brand: {
    name: "Satinder Smartmart",
    description:
