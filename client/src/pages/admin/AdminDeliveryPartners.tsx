          ...
          {partners.map((p) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`px-2.5 py-1 text-[10px] font-semibold rounded-full ${p.isActive ? "bg-app-success/20 text-app-success" : "bg-red-100 text-red-700"}`}
                >
              ...
              <button
                ...
                className={`w-full py-2 text-xs font-medium rounded-lg transition-colors ${p.isActive ? "bg-red-50 text-red-600 hover:bg-red-100" : "bg-app-success/10 text-app-success hover:bg-app-success/20"}`}
              >
