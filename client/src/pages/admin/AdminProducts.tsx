      ...
      <div className="bg-white rounded-2xl shadow-sm border border-app-border overflow-hidden">
        <div className="px-6 py-5 border-b border-app-border flex items-center justify-between gap-4 flex-wrap">
          ...
          <Link
            ...
            className="flex items-center gap-2 px-4 py-2 bg-app-green text-white rounded-xl hover:bg-app-green hover:bg-app-green-light transition-colors font-medium text-sm"
          >
              ...
              {products.length === 0 ? (
                ...
                products.map((product) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-2.5 py-1 rounded-full text-xs font-semibold ${product.stock > 0 ? "bg-app-success/20 text-app-success" : "bg-red-100 text-red-700"}`}
                      >
                        {product.stock > 0
