...
const Footer = () => {
  return (
    <footer className="bg-app-green text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-app-green-lighter/10 rounded-full blur-[120px] -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-app-orange/10 rounded-full blur-[120px] translate-x-1/2 translate-y-1/2" />
