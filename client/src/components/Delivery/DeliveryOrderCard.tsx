        ...
        <div className="px-5 py-3 border-t border-app-border flex flex-wrap gap-2">
          ...
          {order.status === "Out for Delivery" && (
            <button
              ...
              className="px-4 py-2 text-sm font-medium bg-app-success/10 text-app-success rounded-xl hover:bg-app-success/20 transition-colors flex items-center gap-1.5"
            >
